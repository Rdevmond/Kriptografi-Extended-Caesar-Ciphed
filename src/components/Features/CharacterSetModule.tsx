    ...
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold mb-2 text-slate-900 flex items-center gap-2">
          ...
          Himpunan Karakter ({SET_LENGTH} Basis)
        </h2>
        <p className="text-slate-600">
          Extended Caesar Cipher ini menggunakan {SET_LENGTH} karakter yang mencakup huruf, angka, dan simbol untuk memperluas ruang kunci.
        </p>
      </div>
      ...
      <Card>
        <div className="flex items-center gap-2 mb-4 text-slate-800">
          ...
          <h3 className="font-semibold text-lg">Tabel Indeks Karakter</h3>
        </div>
